...
//    #error Component c_UART_v2_50 requires cy_boot v3.0 or later
//#endif /* (CY_PSOC5LP) */
...
uint8_t UART_1_ReadControlRegister(void) ;
void UART_1_WriteControlRegister(uint8_t control) ;
...
/* Only if RX is enabled */
    ...
    void UART_1_SetRxAddressMode(uint8_t addressMode)
                                                           ;
    void UART_1_SetRxAddress1(uint8_t address) ;
    void UART_1_SetRxAddress2(uint8_t address) ;

    void  UART_1_SetRxInterruptMode(uint8_t intSrc) ;
...
/* Only if TX is enabled */
    ...
    void UART_1_SetTxInterruptMode(uint8_t intSrc) ;
    void UART_1_WriteTxData(uint8_t txDataByte) ;
    uint8_t UART_1_ReadTxStatus(void) ;
    void UART_1_PutChar(uint8_t txDataByte) ;
    void UART_1_PutString(const char8 string[]) ;
    void UART_1_PutArray(const uint8_t string[], uint8 byteCount)
                                                            ;
    void UART_1_PutCRLF(uint8_t txDataByte) ;
    void UART_1_ClearTxBuffer(void) ;
    void UART_1_SetTxAddressMode(uint8_t addressMode) ;
    void UART_1_SendBreak(uint8_t retMode) ;
...
/* Communication bootloader APIs */
    ...
    cystatus UART_1_CyBtldrCommWrite(const uint8_t pData[], uint16 size, uint16 * count, uint8_t timeOut) CYSMALL
             ;
    cystatus UART_1_CyBtldrCommRead(uint8_t pData[], uint16 size, uint16 * count, uint8_t timeOut) CYSMALL
             ;
...
/* Status Register definitions */
#if( (UART_1_TX_ENABLED) || (UART_1_HD_ENABLED) )
    #if(UART_1_TX_INTERRUPT_ENABLED)
        #define UART_1_TX_VECT_NUM            (uint8_t)UART_1_TXInternalInterrupt__INTC_NUMBER
        #define UART_1_TX_PRIOR_NUM           (uint8_t)UART_1_TXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* UART_1_TX_INTERRUPT_ENABLED */
    ...
    #define UART_1_TX_STS_COMPLETE            (uint8_t)(0x01u << UART_1_TX_STS_COMPLETE_SHIFT)
    #define UART_1_TX_STS_FIFO_EMPTY          (uint8_t)(0x01u << UART_1_TX_STS_FIFO_EMPTY_SHIFT)
    #define UART_1_TX_STS_FIFO_FULL           (uint8_t)(0x01u << UART_1_TX_STS_FIFO_FULL_SHIFT)
    #define UART_1_TX_STS_FIFO_NOT_FULL       (uint8_t)(0x01u << UART_1_TX_STS_FIFO_NOT_FULL_SHIFT)
#endif /* End (UART_1_TX_ENABLED) || (UART_1_HD_ENABLED)*/

#if( (UART_1_RX_ENABLED) || (UART_1_HD_ENABLED) )
    #if(UART_1_RX_INTERRUPT_ENABLED)
        #define UART_1_RX_VECT_NUM            (uint8_t)UART_1_RXInternalInterrupt__INTC_NUMBER
        #define UART_1_RX_PRIOR_NUM           (uint8_t)UART_1_RXInternalInterrupt__INTC_PRIOR_NUM
    #endif /* UART_1_RX_INTERRUPT_ENABLED */
    ...
    #define UART_1_RX_STS_MRKSPC           (uint8_t)(0x01u << UART_1_RX_STS_MRKSPC_SHIFT)
    #define UART_1_RX_STS_BREAK            (uint8_t)(0x01u << UART_1_RX_STS_BREAK_SHIFT)
    #define UART_1_RX_STS_PAR_ERROR        (uint8_t)(0x01u << UART_1_RX_STS_PAR_ERROR_SHIFT)
    #define UART_1_RX_STS_STOP_ERROR       (uint8_t)(0x01u << UART_1_RX_STS_STOP_ERROR_SHIFT)
    #define UART_1_RX_STS_OVERRUN          (uint8_t)(0x01u << UART_1_RX_STS_OVERRUN_SHIFT)
    #define UART_1_RX_STS_FIFO_NOTEMPTY    (uint8_t)(0x01u << UART_1_RX_STS_FIFO_NOTEMPTY_SHIFT)
    #define UART_1_RX_STS_ADDR_MATCH       (uint8_t)(0x01u << UART_1_RX_STS_ADDR_MATCH_SHIFT)
    #define UART_1_RX_STS_SOFT_BUFF_OVER   (uint8_t)(0x01u << UART_1_RX_STS_SOFT_BUFF_OVER_SHIFT)
...
#define UART_1_CTRL_HD_SEND               (uint8_t)(0x01u << UART_1_CTRL_HD_SEND_SHIFT)
#define UART_1_CTRL_HD_SEND_BREAK         (uint8_t)(0x01u << UART_1_CTRL_HD_SEND_BREAK_SHIFT)
#define UART_1_CTRL_MARK                  (uint8_t)(0x01u << UART_1_CTRL_MARK_SHIFT)
#define UART_1_CTRL_PARITY_TYPE_MASK      (uint8_t)(0x03u << UART_1_CTRL_PARITY_TYPE0_SHIFT)
#define UART_1_CTRL_RXADDR_MODE_MASK      (uint8_t)(0x07u << UART_1_CTRL_RXADDR_MODE0_SHIFT)
...
extern uint8_t UART_1_initVar;
    ...
    extern volatile uint8_t UART_1_txBuffer[UART_1_TX_BUFFER_SIZE];
    ...
    extern uint8_t UART_1_errorStatus;
    extern volatile uint8_t UART_1_rxBuffer[UART_1_RX_BUFFER_SIZE];
    extern volatile uint8 UART_1_rxBufferRead;
    extern volatile uint8 UART_1_rxBufferWrite;
    extern volatile uint8_t UART_1_rxBufferLoopDetect;
    extern volatile uint8_t UART_1_rxBufferOverflow;
    #if (UART_1_RXHW_ADDRESS_ENABLED)
        extern volatile uint8_t UART_1_rxAddressMode;
        extern volatile uint8_t UART_1_rxAddressDetected;
...
#define UART_1_INIT_RX_INTERRUPTS_MASK \
                                  (uint8_t)((0 << UART_1_RX_STS_FIFO_NOTEMPTY_SHIFT) \
...
#define UART_1_INIT_TX_INTERRUPTS_MASK \
                                  (uint8_t)((0 << UART_1_TX_STS_COMPLETE_SHIFT) \
