...
/* BUTTON */
#define BUTTON_0_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define BUTTON_0_INBUF_ENABLED 0u
...
#define BUTTON_DRIVEMODE CY_GPIO_DM_STRONG_IN_OFF
#define BUTTON_INBUF_ENABLED 0u
