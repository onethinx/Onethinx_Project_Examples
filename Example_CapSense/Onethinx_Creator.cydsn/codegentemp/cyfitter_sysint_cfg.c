...
/* ARM CM4 */
    ...
    const cy_stc_sysint_t I2C_CapSense_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)I2C_CapSense_SCB_IRQ__INTC_NUMBER,
        .intrPriority = I2C_CapSense_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
