...
/**
* This is a check delay in micro seconds (us) of the address matching event.
* The default value for 100 kHz is 6us. The desired delay must be equal or more than
* the duration of a high period of the SCL clock. Can be re-defined at the build
* level as a compiler parameter.
*/
#ifndef CY_SCB_I2C_ADDR_CHECK_DELAY_IN_US
    #define CY_SCB_I2C_ADDR_CHECK_DELAY_IN_US                         (6U)
#endif
